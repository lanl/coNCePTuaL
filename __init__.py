...
def ncptl_point_to_task_map(*args):
  return _pyncptl.ncptl_point_to_task_map(*args)
ncptl_point_to_task_map = _pyncptl.ncptl_point_to_task_map

def ncptl_conditionally_copy_task_map(*args):
  return _pyncptl.ncptl_conditionally_copy_task_map(*args)
...
def ncptl_func_file_data(*args):
  return _pyncptl.ncptl_func_file_data(*args)
ncptl_func_file_data = _pyncptl.ncptl_func_file_data

def ncptl_dfunc_file_data(*args):
  return _pyncptl.ncptl_dfunc_file_data(*args)
